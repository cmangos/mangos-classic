<<<<<<< HEAD:contrib/vmap_extract_assembler_bin/make vmaps.bat
@echo off
cls
echo.
...
echo Press any key to exit . . .
pause>nul
>>>>>>> 0301056... Make git and users happy with contrib/vmap_extract_assembler_bin/make vmaps.bat:contrib/vmap_extract_assembler_bin/make_vmaps.bat
