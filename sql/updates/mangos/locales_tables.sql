...
-- Дамп структуры для таблица wotlkmangos.locales_creature
...
-- Дамп структуры для таблица wotlkmangos.locales_gameobject
...
-- Дамп структуры для таблица wotlkmangos.locales_gossip_menu_option
...
-- Дамп структуры для таблица wotlkmangos.locales_item
...
-- Дамп структуры для таблица wotlkmangos.locales_npc_text
...
-- Дамп структуры для таблица wotlkmangos.locales_page_text
...
-- Дамп структуры для таблица wotlkmangos.locales_points_of_interest
...
-- Дамп структуры для таблица wotlkmangos.locales_quest
...
-- Дамп структуры для таблица wotlkmangos.locales_questgiver_greeting
DROP TABLE IF EXISTS `locales_questgiver_greeting`;
CREATE TABLE IF NOT EXISTS `locales_questgiver_greeting` (
...
-- Дамп структуры для таблица wotlkmangos.locales_trainer_greeting
DROP TABLE IF EXISTS `locales_trainer_greeting`;
CREATE TABLE IF NOT EXISTS `locales_trainer_greeting` (
