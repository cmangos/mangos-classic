...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_ROGUELIKE_LEVEL_BONUS_MIN,
    CONFIG_UINT32_ROGUELIKE_LEVEL_BONUS_MAX,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_ROGUELIKE_LEVEL_BONUS_CHANCE,
    CONFIG_FLOAT_ROGUELIKE_LOOT_PROGRESSIVE_CHANCE_PER_LEVEL,
    CONFIG_FLOAT_ROGUELIKE_LOOT_PROGRESSIVE_CHANCE_MAX,
    CONFIG_FLOAT_ROGUELIKE_LOOT_BONUS_GEAR_CHANCE,
    CONFIG_FLOAT_ROGUELIKE_LOOT_BONUS_GEAR_RARE_CHANCE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ROGUELIKE_LOOT_DEBUG,
