...
#define DEFAULT_VISIBILITY_BG       180.0f      // default visible distance in BG/Arenas, 180 yards
...
class MANGOS_DLL_SPEC Object
{
    ...
    protected:
        ...
        void BuildMovementUpdate(ByteBuffer * data, uint8 updateFlags, uint32 moveFlags ) const;
