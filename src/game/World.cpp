...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_configUint32Values[CONFIG_UINT32_MAINTENANCE_DAY] = sConfig.GetIntDefault("MaintenanceDay", 4);
    if(int8(m_configUint32Values[CONFIG_UINT32_MAINTENANCE_DAY]) < 0 || int8(m_configUint32Values[CONFIG_UINT32_MAINTENANCE_DAY]) > 6 )
    {
        sLog.outError("MaintenanceDay (%i) must be in range 0..6. Set to %u.",
            m_configUint32Values[CONFIG_UINT32_MAINTENANCE_DAY],4);
        m_configUint32Values[CONFIG_UINT32_MAINTENANCE_DAY] = 4;
    }
    ...
    m_configBoolValues[CONFIG_BOOL_DEATH_BONES_BG]        = sConfig.GetBoolDefault("Death.Bones.BattlegroundOrArena", true);
