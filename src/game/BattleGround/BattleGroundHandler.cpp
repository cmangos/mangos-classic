    ...
    switch (bg->GetTypeID())
    {
        case BATTLEGROUND_WS:
        {
            ...
            if (_player->GetTeam() == ALLIANCE)
                flagCarrier = sObjectMgr.GetPlayer(((BattleGroundWS*)bg)->GetHordeFlagCarrierGuid());
            else
                flagCarrier = sObjectMgr.GetPlayer(((BattleGroundWS*)bg)->GetAllianceFlagCarrierGuid());;
