...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADROGUELIKELEVELBONUSES, "SELECT level, stat, value FROM character_roguelike_level_bonus WHERE guid = '%u'", m_guid.GetCounter());
