...
//#    define MANGOS_IMPORT __attribute__ ((longcall)) Is this still needed for some system? If yes we need to find a defined macro to identify wheter to use longcall or not
